...
export default function DashboardScreen() {
  ...
  const { locations, propertySize, budget, propertyType, userName } = useOnboardingStore();
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
          onPress={() => router.push('/onboarding/conflict-check')}
        >
      ...
      {/* ══ ZONE 2: Journey Accordion ══ */}
      <View style={styles.journeyDivider} />
      <JourneyAccordion onStageChange={setCurrentStage} />
      ...
      >
        <AlonChat stage={currentStage} insetBottom={insets.bottom} />
      </KeyboardAvoidingView>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  statusBarBg: { backgroundColor: Colors.navy800, position: 'absolute', top: 0, left: 0, right: 0, zIndex: 10 },
