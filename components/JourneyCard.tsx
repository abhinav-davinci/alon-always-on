...
const STAGES: Stage[] = [
  ...
  { label: 'Compare', yourTask: 'Pick favourites', alonTask: 'Scoring', status: 'pending',
    alonDetail: 'Match scores, market data & ALON\'s Pick',
    yourDetail: 'Shortlist 2–3 properties to compare',
    ctaLabel: 'Compare properties →',
    ctaInfo: 'ALON scores each property on 7 factors and recommends the best fit.' },
  ...
  { label: 'Legal', yourTask: 'Upload draft', alonTask: 'Verifying', status: 'pending',
    alonDetail: 'Verify builder reputation & flag risky clauses',
